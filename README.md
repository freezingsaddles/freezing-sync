...
- `OPENWEATHERMAP_API_KEY`: The key to your Open Weather Map development account.
- `OPENWEATHERMAP_CACHE_DIR`: The directory for OWM cache files
...
- `OPENWEATHERMAP_CACHE_DIR`: Similarly, where should weather files be stored?
`
